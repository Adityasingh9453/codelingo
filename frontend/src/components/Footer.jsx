export default function Footer() {
  return (
    <footer className="mt-auto border-t border-line py-6 px-5">
      <div className="mx-auto max-w-3xl flex flex-col items-center gap-2 text-center">
        ...
        <div className="flex items-center gap-4 font-mono text-xs text-muted">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 hover:text-offwhite transition-colors"
          >
            {/* GitHub SVG icon */}
          ...
          >
            ...
            adityabhadauriya9453@gmail.com
          </a>
        </div>
