...
const LOGOS = {
  html: (
    <svg viewBox="0 0 128 128" width="40" height="40" xmlns="http://www.w3.org/2000/svg">
      ...
      <path fill="#EBEBEB" d="M64 52.455H45.788L44.53 38.361H64V24.599H29.489l.33 3.692 3.382 37.927H64zm0 35.743l-.061.017-15.327-4.14-.979-10.975H33.816l1.928 21.562 28.193 7.826.063-.017z"/>
      <path fill="#fff" d="M63.961 52.455v13.763h16.928l-1.593 17.854-15.335 4.143v14.319l28.215-7.82.207-2.325 3.234-36.233.336-3.701zm0-27.856v13.762h33.244l.276-3.092.628-6.978.329-3.692z"/>
    </svg>
  ),
  css: (
    <svg viewBox="0 0 128 128" width="40" height="40" xmlns="http://www.w3.org/2000/svg">
      <path fill="#264DE4" d="M19.037 113.876L9.032 1.661h109.936l-10.016 112.198-45.019 12.48z"/>
      <path fill="#2965F1" d="M64 116.8l36.378-10.086 8.559-95.878H64z"/>
      <path fill="#EBEBEB" d="M64 52.455H45.788L44.53 38.361H64V24.599H29.489l.33 3.692 3.382 37.927H64zm0 35.743l-.061.017-15.327-4.14-.979-10.975H33.816l1.928 21.562 28.193 7.826.063-.017z"/>
      <path fill="#fff" d="M63.961 52.455v13.763h16.594l-1.557 17.413-15.037 4.056v14.319l28.215-7.82.207-2.325 3.234-36.233.336-3.701-.001-.001-32.251-.001h.26zm0-27.856v13.762h32.432l.277-3.092.629-6.978.329-3.692z"/>
    </svg>
  ),
  js: (
    <svg viewBox="0 0 128 128" width="40" height="40" xmlns="http://www.w3.org/2000/svg">
